...
export default function MobileBottomNav({
  ...
  return (
    ...
    >
      <div className="mx-4 h-16 rounded-[28px] border border-base-300 bg-base-100/85 px-5 py-2 shadow-xl backdrop-blur">
            ...
            return (
              ...
              >
                ...
                <motion.span
                  ...
                  className="relative z-10 flex h-10 w-10 items-center justify-center rounded-2xl bg-base-200/70"
                >
